...
python generate_dense_embeddings.py \
        ...
        out_file="/home1/deokhk_1/research/MultiQA_data/dense_embeddings/column_only_tb/"	


# Evaluate the model on table split
python dense_retriever.py \
	model_file="/home1/deokhk_1/research/MultiQA/model/DPR/trained_model_checkpoints/column_only/table_best/dpr_biencoder.391" \
